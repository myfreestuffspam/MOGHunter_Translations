...
/*:
 * @target MZ
 * @plugindesc (v1.0) Features a Hud showing the order of actions.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Hud Angle
 * @desc Definition of hud angle.
 * @default 0
 * 
 * @param Hud X-Axis
 * @desc X-Axis definition of the hud.
 * @default 740
 *
 * @param Hud Y-Axis
 * @desc Y-Axis definition of the hud.
 * @default 100
 *
 * @param Enemy X-Axis Offset
 * @desc Enemy icon X-Axis offset setting.
 * @default 16
 *
 * @param Actor X-Axis Offset
 * @desc Setting the X-Axis offset of the allies icon.
 * @default -16
 *
 * @param Active X-Axis
 * @desc X-Axis definition when the battler is in turn.
 * @default -3
 *
 * @param Active Y-Axis
 * @desc Y-Axis definition when the battler is in turn.
 * @default 30
 *
 * @param Gauge Size
 * @desc Meter size definition.
 * @default 160
 *
 * @param Skill Visible
 * @desc Introduce Skill Icon.
 * @default true
 * @type boolean
 * 
 * @param Skill Zoom
 * @desc Skill icon zoom setting.
 * @default 0.6
 *
 * @param Skill X-Axis
 * @desc X-Axis definition of skill icon.
 * @default 0
 *
 * @param Skill Y-Axis
 * @desc Y-Axis definition of skill icon.
 * @default 0
 *
 * @help  
 * =============================================================================
 ...
 * =============================================================================
 * Features a Hud showing the order of actions.
 *
 * =============================================================================
 * IMAGES
 * =============================================================================
* The images must be saved in the folder (img/atb/)
  * To name the battler icons, name it as follows.
 *
 * Actor_ + ACTOR_ID.png
 * Enemy_ + ACTOR_ID.png
 *
